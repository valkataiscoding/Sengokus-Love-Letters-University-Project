...
public class EnemyBehaviour : MonoBehaviour
{
    ...
    void Act()
    {
        switch (state)
        {
            case "Attack":
                ...
                protectorAnimator.Play("Standing Melee Attack Downward");
                break;
            case "Follow":
                FollowPlayer();
                animator.Play("Running");
                protectorAnimator.Play("Run With Sword");
                break;
    ...
    void Start()
    {
        ...
        if (protector.tag == "Ichiro")
        {
            protectorAnimator = GameObject.Find("Ichiro").GetComponent<Animator>();
        }
        else
        {
            protectorAnimator = GameObject.Find("Yuuki").GetComponent<Animator>();
        }
